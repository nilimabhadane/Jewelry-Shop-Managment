...
Public Class MDIParent1
    ...
    Private Sub SaleProductToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles SaleProductToolStripMenuItem.Click
        saleForm.Show()


    End Sub

    Private Sub AddProductToolStripMenuItem1_Click(sender As Object, e As EventArgs) Handles AddProductToolStripMenuItem1.Click
        PurchaseForm.Show()
